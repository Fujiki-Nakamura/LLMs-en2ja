...
exp_name = "fnakamura/t5-large-en2ja_e_v381_pt"
model_name = "fnakamura/t5-large-en2ja_e_v381_pt"
...
class ModelArguments:
    ...
    tokenizer_name: Optional[str] = field(default="fnakamura/t5-large-en2ja")
...
class TrainingArguments:
    output_dir: str = field(default=f"{os.getenv('OUTPUT_DIR')}/{exp_name}")
    overwrite_output_dir: bool = field(default=True)

    do_train: bool = field(default=True)
    do_eval: bool = field(default=True)
    _bs = 4
    per_device_train_batch_size: int = field(default=_bs)
    per_device_eval_batch_size: int = field(default=_bs)
    ...
    logging_steps: int = field(default=3000)
