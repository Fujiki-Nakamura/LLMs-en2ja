...
# exp_name = "fnakamura/gpt2-small-en2ja_nopt"
exp_name = "fnakamura/gpt2-small-en2ja_e1"


@dataclass
class ModelArguments:
    model_name = "fnakamura/gpt2-small-en2ja"
    ...
    tokenizer_name: Optional[str] = field(default=model_name)
...
@dataclass
class DataArguments:
    dataset_name: Optional[str] = field(default="fnakamura/oscar_unshuffled_deduplicated_ja_100000")
