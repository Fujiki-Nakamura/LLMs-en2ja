...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="sonoisa/t5-base-japanese")
    model_type: Optional[str] = field(default="")
    config_name: Optional[str] = field(default="")
    tokenizer_name: Optional[str] = field(default="")
...
class TrainingArguments:
    output_dir: str = field(default="/workspace/data/fnakamura/workspace/t2t/outputs/t5-base-japanese")
