...
class ModelArguments:
    ...
    config_name: Optional[str] = field(default="sonoisa/t5-base-japanese")
    tokenizer_name: Optional[str] = field(default="sonoisa/t5-base-japanese")
...
class TrainingArguments:
    output_dir: str = field(default="/workspace/data/fnakamura/workspace/t2t/outputs/t5-base-ja_no-pt")
    ...
    _steps = 1_000
    logging_steps: int = field(default=_steps)
    save_steps: int = field(default=_steps)
    eval_steps: int = field(default=_steps)
