...
exp_name = "fnakamura/t5-base-en2ja_pt-a"
model_name = "fnakamura/t5-base-en2ja_pt-a"
...
class TrainingArguments:
    ...
    per_device_train_batch_size: int = field(default=20)
    per_device_eval_batch_size: int = field(default=40)
    ...
    hub_model_id: str = field(default=None)  # "fnakamura/t5-base-en2ja_pt-a")
