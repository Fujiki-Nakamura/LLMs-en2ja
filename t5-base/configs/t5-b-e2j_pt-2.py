...
exp_name = "fnakamura/t5-base-en2ja_pt-2"


@dataclass
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="fnakamura/t5-base-en2ja_pt-1")
    from_pt: bool = field(default=False)
    model_type: Optional[str] = field(default="")
    config_name: Optional[str] = field(default="fnakamura/t5-base-en2ja_pt-1")
...
class TrainingArguments:
    output_dir: str = field(default=f"/workspace/data/fnakamura/workspace/t2t/outputs/{exp_name}")
